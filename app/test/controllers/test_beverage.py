...
def test_create_beverage_when_function_have_a_dict_should_return_a_created_beverage(app, beverage: dict):
...
def test_update_beverage_when_function_have_a_dict_should_return_a_updated_beverage(app, beverage: dict):
    ...
    pytest.assume(error is None)
    beverage_from_database, error = BeverageController.get_by_id(_id= created_beverage['_id'])
    pytest.assume(error is None)
...
def test_get_beverage_by_id_when_function_have_a_dict_should_return_a_beverage(app, beverage: dict):
    created_beverage, _ = BeverageController.create(entry= beverage)
...
def test_get_all_beverages_when_function_have_a_dict_should_return_all_beverages(app, beverages: list):
    created_beverages = []
