...
from ..fixtures.beverages import beverage_uri, create_beverage, create_beverages

def test_create_beverage(create_beverage):
...
def test_update_beverage(client, create_beverage, beverage_uri):
...
def test_get_beverage_by_id(client, create_beverage, beverage_uri):
    current_beverage = create_beverage.json
...
def test_get_beverages(client, create_beverages, beverage_uri):
